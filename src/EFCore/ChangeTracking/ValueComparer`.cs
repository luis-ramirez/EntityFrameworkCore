...
namespace Microsoft.EntityFrameworkCore.ChangeTracking
{
    ...
    public class ValueComparer<T> : ValueComparer
    {
        ...
        private Func<object, object, bool> _keyEquals;
        private Func<object, int> _keyHashCode;
        ...
        public ValueComparer()
            : this(
                ...
                CreateDefaultHashCodeExpression(),
                CreateDefaultKeyEqualsExpression(),
                CreateDefaultKeyHashCodeExpression())
        {
        }
        ...
        public ValueComparer(
            ...
            : this(equalsExpression, hashCodeExpression, equalsExpression, hashCodeExpression, snapshotExpression)
        {
        }
        ...
        public ValueComparer(
            [NotNull] Expression<Func<T, T, bool>> equalsExpression,
            [NotNull] Expression<Func<T, int>> hashCodeExpression,
            [NotNull] Expression<Func<T, T, bool>> keyEqualsExpression,
            [NotNull] Expression<Func<T, int>> keyHashCodeExpression)
            : this(equalsExpression, hashCodeExpression, keyEqualsExpression, keyHashCodeExpression, v => v)
        {
        }
        ...
        public ValueComparer(
            ...
            [NotNull] Expression<Func<T, int>> keyHashCodeExpression,
            [NotNull] Expression<Func<T, T>> snapshotExpression)
            : base(equalsExpression, hashCodeExpression, keyEqualsExpression, keyHashCodeExpression, snapshotExpression)
        {
        }

        private static Expression<Func<T, T, bool>> CreateDefaultKeyEqualsExpression()
        {
            var type = typeof(T);
        ...
        private static Expression<Func<T, T, bool>> CreateDefaultEqualsExpression()
        {
            var type = typeof(T);
            var param1 = Expression.Parameter(type, "v1");
            var param2 = Expression.Parameter(type, "v2");
        ...
        private static Expression<Func<T, int>> CreateDefaultKeyHashCodeExpression()
        {
            var type = typeof(T);
            ...
            return CreateDefaultHashCodeExpression();
        }

        private static Expression<Func<T, int>> CreateDefaultHashCodeExpression()
        {
            var type = typeof(T);
            var unwrappedType = type.UnwrapNullableType();
            var param = Expression.Parameter(type, "v");
        ...
        /// </summary>
        public override Func<object, object, bool> KeyEquals
            => NonCapturingLazyInitializer.EnsureInitialized(
                ref _keyEquals, this, c => HandleNulls(c.KeyEqualsExpression));
        ...
        /// </summary>
        public override Func<object, int> KeyHashCode
            => NonCapturingLazyInitializer.EnsureInitialized(
                ref _keyHashCode, this, c => HandleNulls(c.KeyHashCodeExpression));
        ...
        /// </summary>
        public new virtual Expression<Func<T, T, bool>> KeyEqualsExpression
            => (Expression<Func<T, T, bool>>)base.KeyEqualsExpression;
        ...
        /// </summary>
        public new virtual Expression<Func<T, int>> KeyHashCodeExpression
            => (Expression<Func<T, int>>)base.KeyHashCodeExpression;
